...
export default async function AppPage({
  ...
  return (
    <main className="min-h-screen px-3 py-4 sm:px-6 sm:py-8">
      <div className="mx-auto max-w-[1500px] rounded-[36px] border border-white/60 bg-[rgba(255,255,255,0.45)] p-3 shadow-[0_30px_100px_rgba(12,28,22,0.12)] backdrop-blur sm:p-5">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-3">
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[rgba(223,247,234,0.14)] text-lg font-semibold text-[#dff7ea]">
                    R
                  </div>
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-[#8fe0b5]">RecordApp</p>
                    <h1 className="mt-1 text-2xl font-semibold tracking-[-0.03em] sm:text-3xl">Historial de compras con memoria</h1>
                  </div>
                </div>
                <p className="mt-4 max-w-3xl text-sm leading-7 text-[#c4d3cc]">
                  Hola, {userDisplayName}. Tu lista activa, el historial y las sugerencias trabajan juntos para ayudarte a comprar con mas criterio y menos repeticiones.
                </p>
              </div>
